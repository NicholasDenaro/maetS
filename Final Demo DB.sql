...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2015 at 04:28 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `Aggregate`()
    NO SQL
...
('565b9091c08372.39159', NULL, 40, '0000-00-00'),
('565f81aad59a59.22109', NULL, 2, '2015-12-03'),
('565f81dac0e2f3.45230', NULL, 2, '2015-12-03'),
('565f821049e7f9.52799', NULL, 2, '2015-12-03'),
('565f8693228744.19815', NULL, 0, '0000-00-00'),
('565f8cb120e1e3.14776', NULL, 0, '0000-00-00'),
('5665d89bb4a2c6.23633', 'Nick', 14, '2015-12-07'),
('5665e673a98af8.24708', 'Will', 17, '2015-12-07');
...
(123456780, 'John Smith', 'VISA', 'A', '2020-12-27'),
(123456787, 'John Smith', 'VISA', 'A', '2020-12-27'),
...
('565f752780dca4.29732', '0'),
('565f81aad59a59.22109', '0'),
('565f81dac0e2f3.45230', '0'),
('565f821049e7f9.52799', '0'),
('565f87aa79c4c9.05133', '0'),
('565f8c1f1715d6.73971', '0'),
('565f8cb120e1e3.14776', '0'),
('5665c943b28226.39211', '0'),
('5665e673a98af8.24708', '0'),
('56660cf26d6931.65873', '0'),
('54321', '234b63gf5f4536bg'),
('5665d89bb4a2c6.23633', '234b63gf5f4536bg'),
...
('565f8693228744.19815', '432g7h6g45435ff');
...
(NULL, '56660d1dedfca4.32711', '56660cf26d6931.65873'),
...
('565f752780dca4.29732', 'AC', 'crossing with the animals', 'Nintendo', 'http://www.animal-crossing.com/newleaf/_ui/downloads/AnimalCrossing_wallpaper_1920x1200-B.jpg'),
('565f81aad59a59.22109', 'OTHER', 'descr', 'NINTENDOOOOOO', 'http://www.animal-crossing.com/newleaf/_ui/downloads/AnimalCrossing_wallpaper_1920x1200-B.jpg'),
('565f81dac0e2f3.45230', 'OTHER', 'descr', 'NINTENDOOOOOO', 'http://www.animal-crossing.com/newleaf/_ui/downloads/AnimalCrossing_wallpaper_1920x1200-B.jpg'),
('565f821049e7f9.52799', 'OTHER', 'descr', 'NINTENDOOOOOO', 'http://www.animal-crossing.com/newleaf/_ui/downloads/AnimalCrossing_wallpaper_1920x1200-B.jpg'),
('565f8693228744.19815', '', '', '', ''),
('565f87aa79c4c9.05133', '', '', '', ''),
('565f8c1f1715d6.73971', '', '1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890', '', ''),
('565f8cb120e1e3.14776', 'testlongdescription', '1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890', '', ''),
('5665c943b28226.39211', 'This should be visib', 'description seen from shop', 'location', ''),
('5665d89bb4a2c6.23633', 'item', '', '', ''),
('5665e673a98af8.24708', '', '', '', ''),
('56660cf26d6931.65873', '', '', '', '');
...
CREATE TABLE IF NOT EXISTS `loc_addresses` (
  ...
  `zip` double NOT NULL DEFAULT '0',
  `apt_number` double NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('A', 'ssfdfsdf', 'city', 'state', 12345, 1),
('A', 'street', 'city', 'state', 12345, 1),
...
('test', 'street', 'city', 'state', 12345, 1),
...
('565f752780dca4.29732', 50),
('565f87aa79c4c9.05133', 0),
('565f8c1f1715d6.73971', 0),
('5665c943b28226.39211', 10),
('56660cf26d6931.65873', 0);
...
('', '565f752780dca4.29732'),
('', '565f81aad59a59.22109'),
('', '565f81dac0e2f3.45230'),
('', '565f821049e7f9.52799'),
('test', '5665c943b28226.39211');
...
('', '', 0, '', '0000-00-00', '', ''),
('apple', 'a', 3000000000, 'n', '1857-01-11', 'A', 'a@a.com'),
...
('nick', 'nick', 0, '', '0000-00-00', 'Nick', 'will@psu.edu'),
...
('tester', 'test', 230923, '', '2012-11-02', 'test12', 'testemail'),
('tester', 'test', 230923, '', '2012-11-02', 'test13', 'testemail'),
('tester', 'test', 230923, '', '2012-11-02', 'test14', 'testemail'),
('tester', 'test', 230923, '', '2012-11-02', 'test15', 'testemail'),
('tester', 'test', 230923, '', '2012-11-02', 'test16', 'testemail'),
...
('Nick', 'will', 0, '', '0000-00-00', 'Will', 'will@psu.edu'),
('[object HTMLInputElement]', '[object HTMLInputEle', 0, '[', '0000-00-00', '[object HTMLInputEle', '[object HTMLInputElement]');
...
('56660cf26d6931.65873', 'A'),
('5665c943b28226.39211', 'test'),
('565f87aa79c4c9.05133', 'test2'),
...
('2015-12-07', '1234abc', 'CelticAlice220', 'test2', 1, 'comment'),
('2015-12-07', '1423bid', 'ChromeNight89', 'CelticAlice220', 0, NULL),
...
('2015-12-07', '12345123', 'DemoFred123', 'test2', 0, NULL),
...
('2015-12-07', '5665e673a98af8.24708', 'Nick', 'Will', 0, NULL),
('0000-00-00', '12345', 'Sepheroth23', 'CelticAlice220', 0, NULL),
('0000-00-00', '54321', 'Sepheroth23', 'CelticAlice220', 0, NULL),
('2015-12-07', '565f752780dca4.29732', 'test', 'test2', 0, NULL),
('2015-12-07', '565f8c1f1715d6.73971', 'test2', 'CelticAlice220', 0, NULL),
('2015-12-07', '565d0154451453.96219', 'test9', 'Will', 0, NULL),
('2015-12-07', '565d0157f263b8.79446', 'test9', 'Will', 0, NULL),
('2015-12-07', '565d01582b25a1.68925', 'test9', 'Will', 0, NULL),
('2015-12-07', '5665d89bb4a2c6.23633', 'Will', 'Nick', 0, NULL);
...
ALTER TABLE `cash_credit_card`
  ADD PRIMARY KEY (`cnumber`,`username`,`cname`,`ctype`,`expiration`) USING BTREE,
...
ALTER TABLE `cont_phone`
  ADD PRIMARY KEY (`username`,`number`) USING BTREE;
...
ALTER TABLE `loc_addresses`
  ADD PRIMARY KEY (`username`,`street`,`city`,`astate`,`zip`,`apt_number`) USING BTREE;
