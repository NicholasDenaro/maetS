...
if(isset($_SERVER['REQUEST_METHOD']) && $_SERVER['REQUEST_METHOD'] === 'GET')
{
	...
	else
	{
		...
		try
		{
			$_address = json_decode($_GET["address"],true);
		}
		catch(Exception $e)
		{
			echo json_encode(array("error"=>"Address improperly formatted."));
			return;
		}

		if(isset($_GET["remove"]))
		{
			echo removeAddressFromUser($_username,$_address);
		}
		else
		{
			echo addAddressToUser($_username,$_address);
		}
	}
}
